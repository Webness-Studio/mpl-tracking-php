...
class Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('language', $data ?? [], 'hu');
        $this->setIfExists('ids', $data ?? [], null);
        $this->setIfExists('state', $data ?? [], 'last');
    }
    ...
    */
     ...
     * Sets language
     *
     * @param string|null $language Language of response
     *
     * @return self
     */
     ...
     * Sets ids
     *
     * @param string|null $ids Comma separated id list
     *
     * @return self
     */
