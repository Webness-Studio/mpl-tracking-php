<?php
/**
 * RegisteredResponseTrackAndTraceInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RegisteredResponseTrackAndTraceInner Class Doc Comment
 *
 * @category Class
 * @package  WebnessStudio\MPL\Tracking
 * @author   OpenAPI Generator team
 ...
 */
class RegisteredResponseTrackAndTraceInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisteredResponse_trackAndTrace_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('c41', $data ?? [], null);
        $this->setIfExists('c42', $data ?? [], null);
        ...
        $this->setIfExists('c58', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['c5'];
    }

    /**
     * Sets c5
     *
     * @param string|null $c5 c5
     *
     * @return self
     */
    ...
    {
        if (is_null($c5)) {
            throw new \InvalidArgumentException('non-nullable c5 cannot be null');
        }
        $this->container['c5'] = $c5;
     ...
     * @return string|null
     */
    public function getC41()
    {
        return $this->container['c41'];
    }

    /**
     * Sets c41
     *
     * @param string|null $c41 c41
     *
     * @return self
     */
    public function setC41($c41)
    {
        if (is_null($c41)) {
            throw new \InvalidArgumentException('non-nullable c41 cannot be null');
        }
        $this->container['c41'] = $c41;
    ...
    {
        return $this->container['c42'];
    }

    /**
     * Sets c42
     *
     * @param string|null $c42 c42
     *
     * @return self
     */
    public function setC42($c42)
    {
        if (is_null($c42)) {
            throw new \InvalidArgumentException('non-nullable c42 cannot be null');
        }
        $this->container['c42'] = $c42;
     ...
     * @return string|null
     */
    public function getC58()
    {
        return $this->container['c58'];
    }

    /**
     * Sets c58
     *
     * @param string|null $c58 c58
     *
     * @return self
     */
    public function setC58($c58)
    {
        if (is_null($c58)) {
            throw new \InvalidArgumentException('non-nullable c58 cannot be null');
        }
        $this->container['c58'] = $c58;
